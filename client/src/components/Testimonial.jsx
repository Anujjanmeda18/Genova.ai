  ...
  const cardsData = [
    {
      ...
      date: "April 20, 2025",
      review:
        "These AI tools transformed my workflow. Writing and designing content has never been this smooth!",
      rating: 5,
    },
    {
      image:
      ...
      date: "May 10, 2025",
      review:
        "I can now create blog titles and images in minutes. The efficiency boost is unbelievable.",
      rating: 4,
    },
    {
      image:
      ...
      date: "June 5, 2025",
      review:
        "As a content creator, these AI-powered tools are an absolute game-changer for me.",
      rating: 5,
    },
    {
      image:
      ...
      date: "July 15, 2025",
      review:
        "User-friendly and powerful. It feels like I have a full creative team at my fingertips!",
      rating: 4,
    },
  ];
        ...
        {Array(5)
          ...
          .map((_, i) => (
            <svg
              ...
              className="w-4 h-4"
            >
              <path d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.896 1.508 8.298L12 18.896l-7.444 4.604 1.508-8.298L0 9.306l8.332-1.151z" />
            </svg>
          ))}
      </div>
    ...
    <>
      ...
      <div className="text-center max-w-2xl mx-auto mt-16">
        ...
        <p className="text-gray-500 mt-2">
          Hear what our users say about us. Our AI tools are helping creators,
          writers, and professionals every day. Share your story with us!
        </p>
      </div>
