...
const RemoveBackground = () => {
  ...
  return (
    <div className="h-full overflow-y-auto bg-gradient-to-br from-gray-50 via-orange-50/30 to-red-50/30">
      <div className="min-h-full p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto pb-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">Remove backgrounds from images instantly with AI</p>
          </div>

          {/* Main Content Grid with viewport-height limit */}
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl border border-orange-200 p-6">
                ...
                <ul className="space-y-2 text-sm text-orange-800">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Use high-quality images with clear subjects</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-orange-500 mt-1">•</span>
                    <span>Works best with good contrast between subject and background</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-orange-500 mt-1">•</span>
                    <span>Supports portraits, products, and objects</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-orange-500 mt-1">•</span>
                    <span>Download as PNG for transparent background</span>
                  </li>
                </ul>
              </div>
            </div>

            {/* Right Column: Result image - scrollable */}
            {/* Removed fixed/sticky positioning, added overflow and height control */}
            <div
              ...
              <div className="flex-1 p-6 overflow-y-auto">
                {!content && !loading ? (
                  <div className="h-full flex flex-col justify-center items-center text-gray-400">
                    <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-orange-100 rounded-2xl flex items-center justify-center mb-4 shadow-inner">
                  ...
                  <div className="h-full flex flex-col justify-center items-center">
                    <div className="relative mb-6">
                      <div className="w-20 h-20 border-4 border-gray-200 border-t-orange-500 rounded-full animate-spin" />
                    ...
                    <p className="text-gray-600 font-semibold text-lg mb-2">Processing your image...</p>
                    <p className="text-sm text-gray-500">Removing background with AI precision</p>
                  ...
                  <div className="h-full space-y-4 animate-fadeIn">
                    ...
                    {preview && (
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="relative rounded-lg overflow-hidden shadow-md bg-checkerboard">
                    ...
                    {/* Large transparent background preview */}
                    <div>
                      <p className="text-xs font-semibold text-gray-700 mb-2">Transparent Background</p>
                      <div className="relative group rounded-xl overflow-hidden shadow-2xl bg-checkerboard p-4">
                        <img
                          src={content}
                          alt="Processed"
