...
export const AiToolsData = [
    {
        ...
        description: 'Instantly craft well-structured, engaging articles tailored to any topic or audience.',
        Icon: SquarePen,
        bg: { from: '#3588F2', to: '#0BB0D7' },
        path: '/ai/write-article'
    },
    {
        title: 'Smart Blog Titles',
        description: 'Discover catchy, SEO-friendly blog titles that grab attention and boost clicks.',
        Icon: Hash,
    ...
    },
    {
        ...
        description: 'Transform your ideas into stunning visuals with powerful AI-driven image generation.',
        Icon: Image,
    ...
    },
    {
        ...
        description: 'Quickly erase image backgrounds with precision using advanced AI technology.',
        Icon: Eraser,
    ...
    },
    {
        ...
        description: 'Seamlessly remove unwanted objects from photos while keeping details intact.',
        Icon: Scissors,
    ...
    },
    {
        ...
        description: 'Optimize your resume with AI suggestions to stand out and land more interviews.',
        Icon: FileText,
